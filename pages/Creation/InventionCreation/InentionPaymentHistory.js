...
const InventionPaymentHistory = (props) => {
                        ...
                        <View style={{ width: "95%", alignSelf: "center", marginTop: 20 }}>
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    ...
                                    return (
                                        <TouchableOpacity onPress={() => { props.navigation.navigate('InventionPost', { id: item.article_id }) }}>
                                            <LinearGradient
                                                key={index}
                                                colors={[
                                                    "rgba(255, 255, 255, 1)",
...
export default InventionPaymentHistory;
