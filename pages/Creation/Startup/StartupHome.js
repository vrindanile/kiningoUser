        ...
        <View style={{ flex: 1 }}>
          <View style={{ flexDirection: 'row', width: dimensions.SCREEN_WIDTH * 0.93, flex: 1 }}>
            {item.type === 'video' ?
              ...
              :
              <TouchableOpacity onPress={() => { props.navigation.navigate('StartupPost', { id: item.id }) }} style={{ width: '100%', height: 227, alignSelf: 'center', borderRadius: 10, }}>
                <Image source={{
                  uri:
      ...
      <ScrollView style={{
        ...
        <View style={{ top: -20, width: '90%', alignSelf: 'center' }} >
          ...
          <ArtSearch marginTop={0}
            ...
            press={() => { props.navigation.navigate('StartupCategories', { cat_name: {}, from: 'seach' }) }}
        ...
        <View style={{
              ...
              renderItem={({ item, index }) => {
                ...
                return (
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      props.navigation.navigate('StartupCategories', { cat_name: item, from: 'bycategory' });
                    }}
                  >
                    <LinearGradient
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10, marginTop: 35 }}>
            ...
            <TouchableOpacity onPress={() => {
              ...
              props.navigation.navigate('StartupFundRaiserAll')
            }} >
          ...
          <View style={{ width: dimensions.SCREEN_WIDTH * 0.9, alignSelf: 'flex-start', marginTop: 0, marginBottom: 10, marginTop: 10, height: 330 }}>
            ...
            {categoryData.filter(el => el.post_type === 'Fundraiser').length === 0 ? (
              <>
                        ...
                        <View style={styles.flatlistBottomView}>
                          ...
                          < View style={styles.buttonsContainer} >
                            <View style={{
                              ...
                              <View style={{ alignSelf: 'center', width: '40%', textAlign: 'top', textAlign: 'right', }} >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 20, marginBottom: 10 }}>
            ...
            <TouchableOpacity onPress={() => { props.navigation.navigate('StartupViewAll') }}>
              <Text style={{ fontSize: 13, fontWeight: '400', color: '#FFC40C' }}>View all</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10, marginTop: 35 }}>
            ...
            <TouchableOpacity onPress={() => {
              props.navigation.navigate('AllSatrtupSuggested')
            }} >
              <Text style={{ fontSize: 13, fontWeight: '400', color: '#FFC40C' }}>View all</Text>
            </TouchableOpacity>
          </View>
