...
const StartupCategories = (props, route) => {
    ...
    const HomePage = async (removeFilter = false, getnwPage = false) => {
        ...
        var fUrl = startup_home + `?page_no=${newpage}&limit=10`;
        ...
        if (index === 0 && file.post_type === 'Fundraiser') {
            return (
                <View>
                    ...
                    <ProgressBar height={15} width={dimensions.SCREEN_WIDTH * 0.82} backgroundColor={'#E0E0E0'} borderColor={'#E0E0E0'} progress={file.contribution / file.price} color={'#FFC40C'} borderRadius={10} marginLeft={12} />
                                    ...
                                    <View style={{}}>
                                        <Text style={{
                                            fontSize: 11, color: (selectedCategory?.name
                                                === item?.name) ? '#FFC40C' : Mycolors.Black, marginTop: 5, textAlign: 'center', fontWeight: 'bold'
                                        }}>{item?.name}</Text>
                                    </View>
                                    ...
                                    <View onPress={() => {
                                        ...
                                        <TouchableOpacity style={styles.flatlistMainBottomView} onPress={() => {
                                        ...
                                        }}>
                                            {
                                                ...
                                                //     </View>
                                                // </View>
                                                <TouchableOpacity style={styles.flatlistMainBottomView} onPress={() => { props.navigation.navigate('StartupPost', { id: item.id }) }}>
                    ...
                    {isDataEmpty() ?
                        <>
                            <View style={{ position: 'absolute', top: '10%', alignSelf: 'center' }}>
                                <Image source={require('../../../assets/Art/NoPostStartup.png')} style={{ alignSelf: 'center', height: 150, width: 150, }}></Image>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <View style={{ justifyContent: 'center', alignItems: 'center', width: "60%" }}>
                                                <Text style={{
                                                    fontSize: 16, color: (selectedCategory?.name === item?.name) ? '#FFC40C' : '#455A64', marginTop: 5, textAlign: 'center', fontWeight: 'bold'
                                                }}>{item?.name}</Text>
                                            </View>
                                        </TouchableOpacity>
