...
// import { baseUrl, shop_eat_cart, user_payment_method, shop_eat_orders, shop_eat_cart_book_dining, shop_eat_cart_book_table, shop_eat_cart_id, shop_eat_business_id, shop_eat_menu_userid, requestPostApi, requestGetApi, shop_eat, connect_people_create_post, connect_people_newPost, art_getCollection, requestPostApiMedia, art_PostCollection, postApiWithToken2, art_HomePage, addProfile_image, get_profile, delet_article, update_profileImg, creation_addPhoto, creation_profile, creation_delete_article, creation_delete, invention_profile, getAPI, startup_profile } from '../../../WebApi/Service'
...
//                                         <TouchableOpacity style={styles.threeDotsView} onPress={() => { props.navigation.navigate('StartupPaymentHistory') }}>
...
//                                         <TouchableOpacity style={styles.flatlistMainView} onPress={() => { props.navigation.navigate('StartupPost', { id: item[0].article_id }) }}>
...
//                                                             <TouchableOpacity onPress={() => { setSelectedItemId(null), props.navigation.navigate('StartupEditArticle', { id: item[0].article_id, cat: item.category_id, desc: item[0].description, title: item[0].title, category: item[0].category_data, type: item[0].post, price: item[0].ammountRaised }) }} style={{ marginTop: 7, marginBottom: 3, }}>
//                                                                 <Text
...
//                                                         <View style={styles.imageView} onPress={() => { props.navigation.navigate('StartupPost', { id: item[0].article_id }) }}>
...
//                                         <TouchableOpacity style={styles.flatlistMainBottomView} onPress={() => { props.navigation.navigate('StartupPost', { id: item[0].article_id }) }}>
...
//                                     props.navigation.navigate('StartupEditArticle', { id: selectedId, cat: selectedCategoryy, desc: desc, title: title }), setEditModal(false)
...
//                                     props.navigation.navigate('StartupEditArticle', { id: selectedId, cat: selectedCategoryy, desc: desc, title: title }), setProfileModal(false)
