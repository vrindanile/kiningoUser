...
//                     press3={() => { props.navigation.navigate('FashionNotifications') }} img3={require('../../../assets/images/fashion-bell-icon.png')} img3width={25} img3height={22}
//                     press4={() => {
//                         AsyncStorage.clear();
...
//                                         <TouchableOpacity style={styles.threeDotsView} onPress={() => { props.navigation.navigate('FashionUpload') }}>
...
//                         {desData.length === 0 ? (
//                             <Text style={{ fontSize: 16, color: '#0089CF', alignSelf: 'center', alignItems: 'center', justifyContent: 'center', marginTop: 30 }}>No posts Found</Text>
//                         ) : (<FlatList
//                             data={desData}
...
//                                         <TouchableOpacity style={styles.flatlistMainView} onPress={() => { props.navigation.navigate('FashionPost', { id: item[0].article_id }) }}>
...
//                                                             <TouchableOpacity onPress={() => { setSelectedItemId(null), props.navigation.navigate('FashionEditArticle', { id: item[0].article_id, cat: item.category_id, desc: item[0].description, title: item[0].title, category: item[0].category_data }) }}>
//                                                                 <Text
...
//                                                         <View style={styles.imageView} onPress={() => { props.navigation.navigate('FashionPost ', { id: item[0].article_id }) }}>
...
//                                         <TouchableOpacity style={styles.flatlistMainBottomView} onPress={() => { props.navigation.navigate('FashionPost', { id: item[0].article_id }) }}>
...
//                                 <Image source={require('../../../assets/Art/GalleryCreation.png')} style={{ width: 40, height: 40, alignSelf: 'center', tintColor: '#0089CF' }} />
...
//                                 <Image source={require('../../../assets/Art/cameraCreation.png')} style={{ width: 40, height: 35, alignSelf: 'center', tintColor: '#0089CF' }} />
...
const FashionProfile = (props) => {
    ...
    const ArtCategory = async () => {
        ...
        console.log('the res after sucess of profile vrinda', Object.keys(responseJson.body).length === 0)
        if (Object.keys(responseJson.body).length === 0) {
            // If data is null, set the states to 0
            console.log('0 is called  kkkkkkkk',);
            setLikes(0);
        ...
        <SafeAreaView scrollEnabled={scrollEnabled} style={{ height: '100%', backgroundColor: '#F8F8F8' }}>
            <ScrollView>
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 50, marginLeft: 28, }}>
                        <Text style={{ fontSize: 16, fontWeight: '500', color: '#263238' }}>My posts</Text>
                        ...
                        >
                            <TouchableOpacity
                                style={{
                                    ...
                                    width: '50%',
                                    height: 47,
                                    backgroundColor: selectedButton === 'Informational' ? '#0089CF' : 'white',
                            ...
                            <TouchableOpacity
                                style={{
                                    ...
                                    height: 47,
                                    width: '50%',
                                    backgroundColor: selectedButton === 'Fundraiser' ? '#0089CF' : 'white',
                                }}
                    ...
                    <View style={{ width: dimensions.SCREEN_WIDTH * 0.9, alignSelf: 'center', marginTop: 10, alignSelf: 'center', justifyContent: 'center' }}>
                        {desData.length === 0 ? (
                            <Text style={{ fontSize: 16, color: '#0089CF', alignSelf: 'center', alignItems: 'center', justifyContent: 'center', marginTop: 30 }}>No posts found</Text>
                        ) : (<FlatList
                            data={desData}
                                                ...
                                                <View style={{ position: 'relative', }}>
                                                    ...
                                                    {selectedItemId === item[0].article_id && (
                                                        ...
                                                        >
                                                            ...
                                                            <TouchableOpacity onPress={() => { setSelectedItemId(null), props.navigation.navigate('FashionEditArticle', { id: item[0].article_id, cat: item.category_id, desc: item[0].description, title: item[0].title, category: item[0].category_data, type: item[0].post, price: item[0].ammountRaised }) }} style={{ marginTop: 7, marginBottom: 3, }}>
                                                                <Text
                    ...
                    <ScrollView
                        ...
                        <View style={{ width: '90%', alignSelf: 'center', marginTop: 20 }}>
                            <View style={{ backgroundColor: '#F8F8F8', paddingHorizontal: 10, paddingVertical: 20, borderRadius: 10 }}>
                                <TouchableOpacity style={{ marginHorizontal: 20, flexDirection: 'row', alignItems: 'center' }} onPress={() => {
                                    console.log('my id111', title)
                                    props.navigation.navigate('FashionEditArticle', { id: selectedId, cat: selectedCategoryy, desc: desc, title: title }), setEditModal(false)
                    ...
                    <ScrollView
                        ...
                        <View style={{ width: '90%', alignSelf: 'center', marginTop: 20 }}>
                            ...
                            <View style={{ borderRadius: 10, }}>
                                ...
                                <TouchableOpacity style={{ marginHorizontal: 10, flexDirection: 'row', alignItems: 'center' }} onPress={() => {
                                    props.navigation.navigate('FashionEditArticle', { id: selectedId, cat: selectedCategoryy, desc: desc, title: title }), setProfileModal(false)
