...
// const FashionCategories = (props, route) => {
...
//                             <Text style={{ color: '#0089CF', fontWeight: '500', textDecorationLine: "underline", textDecorationColor: '#0089CF' }} >View All</Text>
//                         </TouchableOpacity>
//                     </View>
//                 </View>
...
//                                                 === item?.name) ? '#0089CF' : Mycolors.Black, marginTop: 5, textAlign: 'center', fontWeight: 'bold'
//                                         }}>{item?.name}</Text>
//                                     </View>
...
//                     />
//                 </View>
//                 <View style={{ width: dimensions.SCREEN_WIDTH * 0.9, alignSelf: 'center', marginTop: 10, height: '55%', }}>
//                     <FlatList
//                         data={articleData}
...
//                                 <Image source={require('../../../assets/Art/FashionNoPost.png')} style={{ alignSelf: 'center', height: 150, width: 150, }}></Image>
...
//                                                 <Text style={{
//                                                     fontSize: 16, color: (selectedCategory?.name === item?.name) ? '#0089CF' : '#455A64', marginTop: 5, textAlign: 'center', fontWeight: 'bold'
//                                                 }}>{item?.name}</Text>
//                                             </View>
//                                         </TouchableOpacity>
...
import { baseUrl, shop_eat_cart, user_payment_method, shop_eat_orders, shop_eat_cart_book_dining, shop_eat_cart_book_table, shop_eat_cart_id, shop_eat_business_id, shop_eat_menu_userid, requestPostApi, requestGetApi, shop_eat, connect_people_create_post, connect_people_newPost, art_getCollection, requestPostApiMedia, art_PostCollection, postApiWithToken2, art_HomePage, creation_categories, creation_home, creation_Commonhome, invention_home, creation_Fashion } from '../../../WebApi/Service'
        ...
        if (index === 0 && file.post_type === 'Fundraiser') {
            return (
                <View>
                    ...
                    <ProgressBar height={15} width={dimensions.SCREEN_WIDTH * 0.82} backgroundColor={'#E0E0E0'} borderColor={'#E0E0E0'} progress={file.contribution / file.price} color={'#0089CF'} borderRadius={10} marginLeft={12} />
                                    ...
                                    <View onPress={() => {
                                        ...
                                        <TouchableOpacity style={styles.flatlistMainBottomView} onPress={() => {
                                        ...
                                        }}>
                                            {
                                                ...
                                                //     </View>
                                                // </View>
                                                <TouchableOpacity style={styles.flatlistMainBottomView} onPress={() => { props.navigation.navigate('FashionPost', { id: item.id }) }}>
