...
//   const theme = {
//     colors: {
//       text: "orange", // Change this to your desired color
...
//                 paddingLeft: 0,
//                 fontSize: 13,
//                 height: 90, // Adjust the height for multiline input
//                 fontWeight: "400",
//                 color: "#000000",
//               },
//             ]}
...
//             <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', }}>
//               <TouchableOpacity style={{ width: 150, height: 150, }} onPress={openImageModal}>
//                 <Image source={require('../../../assets/Art/cameraCreation.png')} style={{ width: 40, height: 40, alignSelf: 'center', tintColor: '#0089CF' }} />
//                 <Text style={{ textAlign: 'center', color: Mycolors.TEXT_COLOR }}>Select Photos</Text>
//               </TouchableOpacity>
//               <TouchableOpacity style={{ width: 150, height: 150 }} onPress={openVideoModal} >
//                 <Image source={require('../../../assets/Art/VideoCamera.png')} style={{ width: 40, height: 35, alignSelf: 'center', tintColor: '#0089CF' }} />
//                 <Text style={{ textAlign: 'center', color: Mycolors.TEXT_COLOR }}>Select Videos</Text>
//               </TouchableOpacity>
//             </View>
//           </View>
...
const FashionUpload = (props) => {
  ...
  const ArtCategory = async () => {
    ...
    const { responseJson, err } = await requestGetApi(fUrl, '', 'GET', User.token)
    setLoading(false)
    console.log('the res Home categoriess==>>', responseJson)
    if (responseJson.headers.success == 1) {
      console.log('the res after sucess', responseJson.body.data)
      setCategorydata(responseJson.body.data)
      // Toast.show({ text1: responseJson.headers.message });
    ...
    <SafeAreaView scrollEnabled={scrollEnabled} style={{ height: '100%', backgroundColor: '#F8F8F8' }}>
      <ScrollView>
        ...
        <View style={{ width: '85%', alignSelf: 'center', marginTop: 30 }}>
          ...
          <View style={{ width: dimensions.SCREEN_WIDTH * 0.9, alignSelf: 'flex-start', marginTop: 0, marginTop: 10 }}>
            <FlatList
              data={categoryData}
              showsHorizontalScrollIndicator={true}
              horizontal
