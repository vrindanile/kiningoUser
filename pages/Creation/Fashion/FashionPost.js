...
const FashionPost = (props, route) => {
  ...
  const ArtCategory = async (id) => {
    ...
    console.log('the res of specific id from cooking', responseJson.body.data.images[0].post_type);
  ...
  const Likepost = async () => {
    ...
    const { responseJson, err } = await requestPostApi(creation_react + 52, data, 'POST', User.token)
    setLoading(false)
    if (responseJson.headers.success == 1) {
  ...
  const Sendcomment = async () => {
    ...
    if (userMessage?.trim()?.length === 0 || (userMessage?.trim()?.length === initalMess.trim()?.length)) {
      ...
      const { responseJson, err } = await requestPostApi(creation_addComments + 52, data, 'POST', User.token)
      setLoading(false)
  ...
  const LikeComment = async (item) => {
    ...
    console.log(data);
    console.log('====================================');
    const { responseJson, err } = await requestPostApi(creation_reactComment + 52, data, 'POST', User.token)
    setLoading(false)
                  ...
                  {images.length != 0 ? (
                    <>
                      <ImageSlider
                        ...
                        closeIconColor="#0089CF"
                        onItemChanged={handleItemChanged}
                        activeIndicatorStyle={{ backgroundColor: '#0089CF', }}
                ...
                <Image
                  ...
                  source={
                    totlaLike
                      ...
                      : require('../../../assets/Art/ThumbsUpFashion.png')}
                  ...
                  source={
                    totalDislike
                      ...
                      : require
                        ...
                        ('../../../assets/Art/ThumbsDownFashion.png') // Use like image
                  } // Use like image
                            ...
                            <View>
                              ...
                              <View style={{ marginTop: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                  ...
                                  <Image source={
                                    ...
                                    item.total_Disikes
                                      ...
                                      : require
                                        ...
                                        ('../../../assets/Art/ThumbsDownFashion.png') // Use like 
                                ...
                                >
                                  ...
                                  } style={{ height: 20, width: 20, marginLeft: 23, tintColor: '#0089CF' }} />
                                ...
                                <TouchableOpacity onPress={() => {
                                  ...
                                  <Image source={require('../../../assets/images/people-reply-image.png')} style={{ tintColor: '#0089CF' }} />
                                  <Text style={{ fontSize: 14, fontWeight: '500', color: '#0089CF', marginLeft: 10 }}>Reply</Text>
                                </TouchableOpacity>
      ...
      <Modal
        ...
        >
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 30, marginRight: 40 }}>
            <TouchableOpacity style={{ backgroundColor: '#0089CF', height: 40, width: 100, marginRight: 30, borderRadius: 10 }} onPress={() => { setEditModal(false) }}>
            ...
            <TouchableOpacity style={{ backgroundColor: '#0089CF', height: 40, width: 100, borderRadius: 10 }}
