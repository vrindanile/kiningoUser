...
import SearchInputEnt from '../../../component/SearchInputEnt';
// import { ImageSlider } from "react-native-image-slider-banner";
import { baseUrl, shop_eat_cart, user_payment_method, shop_eat_orders, shop_eat_cart_book_dining, shop_eat_cart_book_table, shop_eat_cart_id, shop_eat_business_id, shop_eat_menu_userid, requestPostApi, requestGetApi, shop_eat, connect_people_create_post, connect_people_newPost, art_getCollection, requestPostApiMedia, art_PostCollection, postApiWithToken2, art_HomePage, art_likeDislike, article_id, all_coments, add_comments, react_comments, delete_comments, edit_comment, post_reportSuggestion, get_reportSuggestion, creation_article, creation_home, creation_react, creation_addComments, creation_reactComment, creation_getComment, creation_editComment, creation_deleteComment, creation_get_report, creation_post_report, Invention_article, Startup_article } from '../../../WebApi/Service'
import { useSelector, useDispatch } from 'react-redux';
import { VideoModel } from '../../../component/VideoModel';
    ...
    <SafeAreaView scrollEnabled={scrollEnabled} style={{ height: '100%', backgroundColor: '#F8F8F8' }}>
        ...
        <ScrollView>
          ...
          <View style={{ width: '90%', alignSelf: 'center', paddingVertical: 10 }}>
            ...
            {contributed != 0 ? <View style={{ marginTop: 10, marginVertical: 5 }}>
              <Text style={{ fontSize: 15, fontWeight: '700', color: '#ED1C24' }}>You have already contributed ${contributed} to this project</Text>
            </View> : null}
            <Text style={styles.descriptionText}>
              {description}
            </Text>
            {typeArticle == 'Fundraiser' ? < View >
              ...
              <ProgressBar height={15} width={dimensions.SCREEN_WIDTH * 0.90} backgroundColor={'#E0E0E0'} borderColor={'#E0E0E0'} progress={progress} color={'#ED1C24'} borderRadius={10} />
                            ...
                            <View>
                              ...
                              <View style={{
                                ...
                                >
                                  ...
                                  } style={{ height: 20, width: 20, tintColor: '#ED1C24', marginLeft: 5 }} />
                                ...
                                <TouchableOpacity onPress={() => {
                                  ...
                                  <Image source={require('../../../assets/images/people-reply-image.png')} style={{ tintColor: '#ED1C24', marginLeft: -20 }} />
      ...
      <Modal
        ...
        >
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 30, marginRight: 40 }}>
            <TouchableOpacity style={{ backgroundColor: '#ED1C24', height: 40, width: 100, marginRight: 30, borderRadius: 10 }} onPress={() => { setEditModal(false) }}>
              <Text style={{ color: 'white', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', marginTop: 8, fontSize: 14, fontWeight: '600' }}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ backgroundColor: '#ED1C24', height: 40, width: 100, borderRadius: 10 }}
              onPress={() => { typeEdit === 'reply' ? Createpos(selectedId) : Createpos(selectedId) }
            ...
            <View style={{ width: '90%', alignSelf: 'center', marginTop: 20 }}>
              ...
              <View style={{ marginTop: 10 }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                  ...
                  }} style={{ height: 30, width: 60, backgroundColor: '#ED1C24', borderRadius: 6, justifyContent: 'center' }}>
      ...
      >
        <ScrollView style={{ height: dimensions.SCREEN_HEIGHT, backgroundColor: '#fff', borderRadius: 8, }}>
          <TouchableOpacity style={{ flex: 1, justifyContent: 'flex-start', marginLeft: '90%', marginTop: 15 }} onPress={() => setPaymentModal(false)
            ...
            <Image source={require('../../../assets/images/dating-reject-image.png')} style={{ tintColor: '#ED1C24' }}></Image>
          </TouchableOpacity>
          <Text style={{ fontSize: 20, fontWeight: '700', color: '#ED1C24', textAlign: 'center', marginBottom: 20, marginTop: 10 }}>Back this project</Text>
          <View style={{}}>
            <Text style={{
          ...
          <View style={{ width: '93%', height: 'auto', borderRadius: 6, borderWidth: 1, borderColor: 'gray', marginTop: 12, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', }}>
            ...
            />
            <TouchableOpacity style={{ width: '30%', height: 50, backgroundColor: '#ED1C24', marginRight: 12, justifyContent: 'center', alignItems: 'center', alignSelf: 'center', borderRadius: 4, }} onPress={() => {
              if (!myammount) {
