...
const CookingNotifications = (props) => {
    ...
    const statusNotification = async () => {
        console.log('my status has bee called');
        setLoading(true)
        const data = {
                ...
                <View style={{ width: '100%', alignSelf: 'center', marginTop: 10, paddingHorizontal: 10, }}>
                    ...
                    {notificationData.length != 0 ?
                        ...
                        <View style={{ alignSelf: 'center', width: '90%' }}>
                            <Image source={require('../../../assets/Art/NotificationCooking.png')} style={{ width: 180, height: 180, alignItems: 'center', justifyContent: 'center', alignSelf: 'center', marginTop: '30%' }}></Image>
