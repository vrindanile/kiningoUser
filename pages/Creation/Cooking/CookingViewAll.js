    ...
    return (
        ...
        <SafeAreaView scrollEnabled={scrollEnabled} style={{ height: '100%', backgroundColor: '#F8F8F8' }}>
            ...
            <View style={{
                ...
                <View style={{ width: dimensions.SCREEN_WIDTH * 0.9, alignSelf: 'center', height: dimensions.SCREEN_HEIGHT * 0.79, }}>
                    {categoryData.length === 0 ? (
                        <>
                                        ...
                                        <View
                                            ...
                                            <TouchableOpacity style={styles.flatlistMainBottomView} onPress={() => {
                                                ...
                                                {item.post_type == 'Fundraiser' ? < View >
                                                    ...
                                                    <ProgressBar height={15} width={dimensions.SCREEN_WIDTH * 0.82} backgroundColor={'#E0E0E0'} borderColor={'#E0E0E0'} progress={item.total_amount_raised / item.project_estimate} color={'#ED1C24'} borderRadius={10} marginLeft={12} />
