...
const EntertainmentPayment = (props) => {
    ...
    const placeOrder = async () => {
        if (checkitem == '') {
            ...
            var data = {
                ...
                "order_type": props.route.params.orderType,
                "product_id": 115,
                ...
                "schedule_time_from": "2024-01-03 10:00:00"
            }
            console.log('the form data==>>', data)
                    ...
                    <View style={{ width: '92%', alignSelf: 'center' }}>
                        ...
                        {addpayment ?
                            ...
                            <KeyboardAvoidingView
                                ...
                                style={{ flex: 1 }}>
                                <View style={{}}>
                                    {console.log('my new card console')}
                                    <CardField
                                        accessible={true}
...
export default EntertainmentPayment