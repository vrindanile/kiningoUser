                ...
                <View style={{ backgroundColor: 'rgba(248, 248, 248, 1)' }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity onPress={() => setShippingAddressPopUp(true)} >
                            <Image source={require('../../../assets/filterOption.png')} style={{ width: 45, height: 45, borderRadius: 10, top: 23 }}></Image>
                        </TouchableOpacity>
                    </View>
                    <View style={{ marginTop: 23, marginLeft: 17, flexDirection: 'row' }}>
                        ...
                        <View style={{ width: '50%', height: 18 }}>
                            <Text style={{ fontFamily: 'Roboto', fontWeight: '300', fontSize: 18, color: Mycolors.TXT, height: 34, top: 5 }}>23 Events</Text>
                        </View>
                        <View style={styles.cateView}>
                    ...
                    <View style={{
                        width: 378, height: 410, backgroundColor: 'white', borderRadius: 15, left: 5, shadowRadius: 30,
                        shadowOpacity: 1.0,
                        elevation: 3,
                    }}>
                        <View style={{ flexDirection: 'row', }}>
                            <Image source={require('../../../assets/eventTwo.png')} style={{ width: 378, height: 261, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}></Image>
                        ...
                        <View style={{ flexDirection: 'row', height: 15 }}>
                            <Text style={styles.eventTypeTxt}>Private Event</Text>

                            <Text style={styles.eventTypeTxt}>28 Attendee</Text>
                            <Image source={require('../../../assets/googleMap.png')} style={{ width: 42, height: 42, overflow: 'hidden', top: -28, marginLeft: '30%' }}></Image>
                        ...
                        <TouchableOpacity style={{
                            width: 182, height: 41, borderRadius: 32, backgroundColor: 'white', shadowRadius: 30,
                            shadowOpacity: 1.0,
                            elevation: 3, marginTop: 6, marginLeft: 15
                        }}>
                            <Text style={{ fontFamily: 'Roboto', fontWeight: '400', fontSize: 16, color: Mycolors.BLACK, alignSelf: 'center', marginTop: 7 }}>Send Message</Text>
                        </TouchableOpacity>
                    </View>
                    <View >
                        <View style={{ flexDirection: 'row', }}>
