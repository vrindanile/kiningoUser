...
const Header = (props) => {
    return (
        ...
        //     {props.press4 ? <TouchableOpacity style={{
        //         width: props.img3width ? props.img3width : 'auto',
        //         height: props.img3height ? props.img3height : 'auto',
        ...
        //         <Image source={require('../../../../assets/frProfile6.png')} style={{ width: 40, height: 40, marginLeft: 12 }}></Image>
        ...
        >
            {props.press1 ? (
                <TouchableOpacity
                    ...
                    onPress={props.press1}
                >
                    {props.img1 ? <Image source={props.img1} style={{ width: '100%', height: '100%', alignSelf: 'center' }} /> : null}
                </TouchableOpacity>
            ) : null}
            ...
            {props.press2 ? (
                <TouchableOpacity
                    ...
                    onPress={props.press2}
                >
                    {props.img2 ? <Image source={props.img2} style={{ width: '100%', height: '100%', alignSelf: 'center' }} /> : null}
                    {props.title2 ? (
                        <View style={{}}>
                            <Text
                                style={{
                                    ...
                                    color: props.color ? props.color : Mycolors.Black,
            ...
            {props.press4 ? (
                <TouchableOpacity
                    ...
                    onPress={props.press4}
                >
                    <Image source={require('../../../../assets/People/hamburgerPeopleProfile.png')} style={{ width: 40, height: 40, marginLeft: 12 }} />
                </TouchableOpacity>
            ) : null}
            ...
            {props.press3 ? (
                <TouchableOpacity
                    ...
                    onPress={props.press3}
                >
                    {props.img3 ? <Image source={props.img3} style={{ width: '100%', height: '100%', alignSelf: 'center' }} /> : null}
                </TouchableOpacity>
            ) : null}
        </View>
    )
