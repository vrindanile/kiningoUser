...
const UserProfile = (props) => {
    ...
    const changeProfileImg = async (image) => {
        ...
        if (image != '') {
            ...
            feedBackData.append('image', {
                name: imageName,
                type: image.mime,
                uri: image.path,
            });
        }
        feedBackData.append('emailid', userInfo.email);
        feedBackData.append('phone', userInfo.phone);
        feedBackData.append('fullname', userInfo.fullname);
        ...
        try {
            ...
            axios({
                url: "https://nileprojects.in/roadman/dev/api/personal-details-driver",
                method: 'POST',
                data: feedBackData,
                headers: {
